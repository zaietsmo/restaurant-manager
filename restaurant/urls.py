...
urlpatterns = [
    ...
    path("dish-type/create/", views.DishTypeCreateView.as_view(), name="dish_type_create"),
    path("dish-type/<int:pk>/edit/", views.DishTypeUpdateView.as_view(), name="dish_type_edit"),
]
